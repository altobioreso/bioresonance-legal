# Bioresonance website and legal pages

Static English marketing website and legal pages for the Bioresonance iOS and
Android application.

- `privacy.html`: Privacy Policy
- `terms.html`: Terms of Use
- `index.html`: responsive English product landing page
- `assets/landing/`: optimized web imagery used by the landing page
...
connected later through Gandi DNS without changing the legal content.
